...
public class BookingDateWithdrawProcess extends AppAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	BookingDateUserApplicant bookingDate = (BookingDateUserApplicant)dynaForm.get("bookingDate");
     	...
     	int rowCount = appService.updateBookingDateWithdrawn(bookingDate, getApplicantLoggedIn().getApplicantId());
