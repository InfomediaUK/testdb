...
public class SecretWordProcess extends ZapAction
{
  ...
  public ActionForward validateSecretWord(ActionMapping mapping, ActionForm form, HttpServletRequest request)
  {
    ...
    String secretWord = getApplicantLoggedIn().getUser().getSecretWord();
    ...
    {
      logger.debug("Incorrect secret word attempt - " + getApplicantLoggedIn().getUser().getLogin() + " " + secretWordKey1 + "=" + secretWordValue1 + " " + secretWordKey2 + "=" + secretWordValue2
