...
public class ReasonForRequestNewProcess extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		try {
		  int rowCount = adminService.insertReasonForRequest(reasonForRequest, getAdministratorLoggedIn().getAdministratorId());
		}  
