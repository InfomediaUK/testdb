...
public class LocationJobProfileNew extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	for (String str: selectedItems) {
            ...
            int rowCount = adminService.insertLocationJobProfile(ljp, getAdministratorLoggedIn().getAdministratorId());
    	}
