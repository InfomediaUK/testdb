...
public class EmailActionNewProcess extends EmailActionCommon
{
  ...
  public ActionForward doExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
  {
    ...
    String html = (String)dynaForm.get("html");
    ...
    if (writeTemplate(textTemplateFileName, text) && writeTemplate(htmlTemplateFileName, html))
    {
      ...
      try
      {
        int rowCount = adminService.insertEmailAction(emailAction, getAdministratorLoggedIn().getAdministratorId());
      }
