...
public class ClientAgencyGradeDelete extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	for (String str: selectedItems) {
            ...
            Integer clientAgencyGradeId = new Integer(st.nextToken().trim());
            Integer noOfChanges = new Integer(st.nextToken().trim());
            int rowCount = adminService.deleteClientAgencyGrade(clientAgencyGradeId, noOfChanges, getAdministratorLoggedIn().getAdministratorId());
    	}
