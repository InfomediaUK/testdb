...
public class LocationManagerJobProfileDelete extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	for (String str: selectedItems) {
    		...
    		int rowCount = adminService.deleteLocationManagerJobProfile(locationManagerJobProfileId, noOfChanges, getAdministratorLoggedIn().getAdministratorId());
    	}
