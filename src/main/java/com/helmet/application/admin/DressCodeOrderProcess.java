...
public class DressCodeOrderProcess extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	int rowcount = adminService.updateDressCodeDisplayOrder(order, zeroiseDisplayOrder, getAdministratorLoggedIn().getAdministratorId());
