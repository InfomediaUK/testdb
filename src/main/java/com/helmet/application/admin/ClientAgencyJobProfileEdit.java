...
public class ClientAgencyJobProfileEdit extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		clientAgencyJobProfile = adminService.getClientAgencyJobProfile(clientAgencyJobProfile.getClientAgencyJobProfileId());
