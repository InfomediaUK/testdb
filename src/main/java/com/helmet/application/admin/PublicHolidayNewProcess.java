...
public class PublicHolidayNewProcess extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		try {
		  int rowCount = adminService.insertPublicHoliday(publicHoliday, getAdministratorLoggedIn().getAdministratorId());
		}  
