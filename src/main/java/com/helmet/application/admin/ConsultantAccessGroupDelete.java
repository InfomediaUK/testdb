...
public class ConsultantAccessGroupDelete extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	for (String str: selectedItems) {
            ...
            Integer consultantAccessGroupId = new Integer(st.nextToken().trim());
            Integer noOfChanges = new Integer(st.nextToken().trim());
            int rowCount = adminService.deleteConsultantAccessGroup(consultantAccessGroupId, noOfChanges, getAdministratorLoggedIn().getAdministratorId());
    	}
