...
public class ClientAgencyDelete extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	for (String str: selectedItems) {
            ...
            Integer clientAgencyId = new Integer(st.nextToken().trim());
            Integer noOfChanges = new Integer(st.nextToken().trim());
            int rowCount = adminService.deleteClientAgency(clientAgencyId, noOfChanges, getAdministratorLoggedIn().getAdministratorId());
    	}
