...
public class LocationJobProfileEditProcess extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	int rowCount = adminService.updateLocationJobProfileRate(locationJobProfile.getLocationJobProfileId(), 
