...
public class AdministratorAccessDelete extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	for (String str: selectedItems) {
            ...
            Integer administratorAccessId = new Integer(st.nextToken().trim());
            Integer noOfChanges = new Integer(st.nextToken().trim());
            int rowCount = adminService.deleteAdministratorAccess(administratorAccessId, noOfChanges, getAdministratorLoggedIn().getAdministratorId());
    	}
