...
public class JobProfileOrderProcess extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	int rowcount = adminService.updateJobProfileDisplayOrder(order, zeroiseDisplayOrder, getAdministratorLoggedIn().getAdministratorId());
