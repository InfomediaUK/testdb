...
public class MgrAccessGroupEditProcess extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		try {
		  int rowCount = adminService.updateMgrAccessGroup(mgrAccessGroup, getAdministratorLoggedIn().getAdministratorId());
		}  
