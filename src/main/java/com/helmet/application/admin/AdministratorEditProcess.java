...
public class AdministratorEditProcess extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		try {
		  int rowCount = adminService.updateAdministrator(administrator, getAdministratorLoggedIn().getAdministratorId());
		}  
