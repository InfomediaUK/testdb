...
public class CompliancyTestEditProcess extends CompliancyTestCommon
{
  ...
  public ActionForward doExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
  {
    ...
    try
    {
      int rowCount = adminService.updateCompliancyTest(compliancyTest, getAdministratorLoggedIn().getAdministratorId());
    }
