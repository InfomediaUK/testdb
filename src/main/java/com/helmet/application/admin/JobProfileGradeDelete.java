...
public class JobProfileGradeDelete extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	for (String str: selectedItems) {
            ...
            Integer jobProfileGradeId = new Integer(st.nextToken().trim());
            Integer noOfChanges = new Integer(st.nextToken().trim());
            int rowCount = adminService.deleteJobProfileGrade(jobProfileGradeId, noOfChanges, getAdministratorLoggedIn().getAdministratorId());
    	}
