...
public class ManagerAccessNew extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	for (String str: selectedItems) {
            ...
            aa.setManagerId(manager.getManagerId());
            aa.setMgrAccessId(new Integer(st.nextToken().trim()));
            int rowCount = adminService.insertManagerAccess(aa, getAdministratorLoggedIn().getAdministratorId());
    	}
