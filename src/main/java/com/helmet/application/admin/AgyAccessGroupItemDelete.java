...
public class AgyAccessGroupItemDelete extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	for (String str: selectedItems) {
            ...
            Integer agyAccessGroupItemId = new Integer(st.nextToken().trim());
            Integer noOfChanges = new Integer(st.nextToken().trim());
            int rowCount = adminService.deleteAgyAccessGroupItem(agyAccessGroupItemId, noOfChanges, getAdministratorLoggedIn().getAdministratorId());
    	}
