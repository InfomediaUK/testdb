...
public class ConsultantAccessDelete extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	for (String str: selectedItems) {
            ...
            Integer consultantAccessId = new Integer(st.nextToken().trim());
            Integer noOfChanges = new Integer(st.nextToken().trim());
            int rowCount = adminService.deleteConsultantAccess(consultantAccessId, noOfChanges, getAdministratorLoggedIn().getAdministratorId());
    	}
