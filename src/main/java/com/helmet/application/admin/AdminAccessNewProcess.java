...
public class AdminAccessNewProcess extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		try {
		  int rowCount = adminService.insertAdminAccess(adminAccess, getAdministratorLoggedIn().getAdministratorId());
		}  
