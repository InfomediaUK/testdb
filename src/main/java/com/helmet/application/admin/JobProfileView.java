...
public class JobProfileView extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	logger.entry("In coming !!!");
     	...
     	JobProfileUserEntity jobProfile = (JobProfileUserEntity)dynaForm.get("jobProfile");

		AdminService adminService = ServiceFactory.getInstance().getAdminService();

		jobProfile = adminService.getJobProfileUserEntity(jobProfile.getJobProfileId());
