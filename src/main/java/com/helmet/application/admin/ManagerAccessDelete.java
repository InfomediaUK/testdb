...
public class ManagerAccessDelete extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	for (String str: selectedItems) {
            ...
            Integer managerAccessId = new Integer(st.nextToken().trim());
            Integer noOfChanges = new Integer(st.nextToken().trim());
            int rowCount = adminService.deleteManagerAccess(managerAccessId, noOfChanges, getAdministratorLoggedIn().getAdministratorId());
    	}
