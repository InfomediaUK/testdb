...
public class JobSubFamilyNewProcess extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		try {
		  int rowCount = adminService.insertJobSubFamily(jobSubFamily, getAdministratorLoggedIn().getAdministratorId());
		}  
