...
public class ConsultantEdit extends AdminAction
{
  ...
  public ActionForward doExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
  {
    ...
    consultant = adminService.getConsultant(consultant.getConsultantId());
    ...
    dynaForm.set("confirmPwd", consultant.getUser().getPwd());
