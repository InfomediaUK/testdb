...
public class IdDocumentNewProcess extends AdminAction
{
  ...
  public ActionForward doExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
  {
    ...
    try
    {
      int rowCount = adminService.insertIdDocument(idDocument, getAdministratorLoggedIn().getAdministratorId());
    }
