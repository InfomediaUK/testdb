...
public class ReasonForRequestEditProcess extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		try {
		  int rowCount = adminService.updateReasonForRequest(reasonForRequest, getAdministratorLoggedIn().getAdministratorId());
		}  
