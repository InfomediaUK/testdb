...
public class SiteOrderProcess extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	int rowcount = adminService.updateSiteDisplayOrder(order, zeroiseDisplayOrder, getAdministratorLoggedIn().getAdministratorId());
