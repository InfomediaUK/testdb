...
public class AdminAccessGroupItemDelete extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	for (String str: selectedItems) {
            ...
            Integer adminAccessGroupItemId = new Integer(st.nextToken().trim());
            Integer noOfChanges = new Integer(st.nextToken().trim());
            int rowCount = adminService.deleteAdminAccessGroupItem(adminAccessGroupItemId, noOfChanges, getAdministratorLoggedIn().getAdministratorId());
    	}
