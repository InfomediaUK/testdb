...
public class ClientAgencyJobProfileEditProcess extends AdminAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	int rowCount = adminService.updateClientAgencyJobProfile(clientAgencyJobProfile, getAdministratorLoggedIn().getAdministratorId());
