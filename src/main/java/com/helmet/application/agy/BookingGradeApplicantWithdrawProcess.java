...
public class BookingGradeApplicantWithdrawProcess extends AgyBookingLockAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		int rc = agyService.updateBookingGradeApplicantWithdraw(bookingGradeApplicant.getBookingGradeApplicantId(), bookingGradeApplicant.getNoOfChanges(), getConsultantLoggedIn().getConsultantId());
