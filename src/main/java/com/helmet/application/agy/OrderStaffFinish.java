...
public class OrderStaffFinish extends AgyAction {
    ...
    if (booking == null || booking.getBookingId() == null)
    {
      ...
      int rc = agyService.insertBooking(newBooking, bookingDates, bookingGrades, bookingExpenses, getConsultantLoggedIn().getConsultantId());
    ...
    else
    {
      ...
      int rc = agyService.updateBooking(booking, bookingDates, bookingGrades, bookingExpenses, getConsultantLoggedIn().getConsultantId());
    ...
    return new ActionForward(actionForward.getName(), actionForward.getPath() + "?bookingId=" + thisBookingId, actionForward.getRedirect());
  }
