...
public class BookingGradeApplicantAcceptProcess extends AgyBookingLockAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		int rc = agyService.updateBookingGradeApplicantAccept(bookingGradeApplicant.getBookingGradeApplicantId(), bookingGradeApplicant.getNoOfChanges(), getConsultantLoggedIn().getConsultantId());
