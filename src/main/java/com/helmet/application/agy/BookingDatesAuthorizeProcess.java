...
public class BookingDatesAuthorizeProcess extends AgyAction
{
  ...
  public ActionForward doExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
  {
    ...
    forward = new ActionForward(forward.getName(), forward.getPath() + "?workedStatus=1", forward.getRedirect());
    return forward;
