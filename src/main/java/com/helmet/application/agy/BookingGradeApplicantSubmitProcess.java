...
public class BookingGradeApplicantSubmitProcess extends AgyBookingLockAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		int rc = agyService.updateBookingGradeApplicantSubmit(bookingId, bookingGradeApplicant.getBookingGradeApplicantId(), bookingGradeApplicant.getNoOfChanges(), getConsultantLoggedIn().getConsultantId());
