...
public class BookingViewSummary extends MgrAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		// the following and all the booking view screens etc SHOULD pass in managerId so that we can check access !!!
