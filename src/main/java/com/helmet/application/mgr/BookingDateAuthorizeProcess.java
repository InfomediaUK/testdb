...
public class BookingDateAuthorizeProcess extends MgrBookingLockAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	BookingDate bookingDate = (BookingDate)dynaForm.get("bookingDate");
     	...
     	int rowCount = mgrService.updateBookingDateAuthorized(bookingDate, getManagerLoggedIn().getManagerId());
