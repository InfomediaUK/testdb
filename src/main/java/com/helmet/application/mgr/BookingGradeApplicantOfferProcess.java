...
public class BookingGradeApplicantOfferProcess extends MgrBookingLockAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
		...
		int rc = mgrService.updateBookingGradeApplicantOffer(bookingGradeApplicant.getBookingGradeApplicantId(), bookingGradeApplicant.getNoOfChanges(), getManagerLoggedIn().getManagerId());
