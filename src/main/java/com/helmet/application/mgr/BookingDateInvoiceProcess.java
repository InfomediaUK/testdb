...
public class BookingDateInvoiceProcess extends MgrBookingLockAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
    	...
    	BookingDate bookingDate = (BookingDate)dynaForm.get("bookingDate");
     	...
     	// TODO - WON'T WORK - invoiceId not set !!!
     	
     	int rowCount = mgrService.updateBookingDateInvoiced(bookingDate, getManagerLoggedIn().getManagerId());
