...
<table cellpadding="0" cellspacing="0" width="100%" height="30">
  <tr>
      ...
      <bean:message key="title.subcontractInvoicesForRemittanceAdvice"/>:&nbsp;<bean:write name="SubcontractInvoicesForRemittanceAdviceFormAgy" property="remittanceAdvice"/>
		</td>
  </tr>
</table>
<logic:present name="SubcontractInvoicesForRemittanceAdviceFormAgy" property="list">
  <logic:empty name="SubcontractInvoicesForRemittanceAdviceFormAgy" property="list">
    <bean:message key="text.noDetails"/>
  </logic:empty>
  <logic:notEmpty name="SubcontractInvoicesForRemittanceAdviceFormAgy" property="list">
...
<logic:iterate id="subcontractInvoiceUser" name="SubcontractInvoicesForRemittanceAdviceFormAgy" property="list" type="com.helmet.bean.SubcontractInvoiceUser">
      <tr>
        <td align="left">
      ...
      <tr>
        ...
        <td align="right"><bean:message key="label.currencySymbol"/><bean:write name="SubcontractInvoicesForRemittanceAdviceFormAgy" property="totalValue" format="#,##0.00"/></td>
        <td align="left">&nbsp;</td>
      </tr>
    </table>
