...
<html:form action="/bookingDatesAddRemoveBackingReportProcess.do" onsubmit="return singleSubmit();">
  <html:hidden property="bookingDateIdStrs" />
  <tr>
		<td align="left" valign="middle" class="title">
      <bean:message key="title.bookingDatesAddRemoveBackingReport"/>
		</td>
...
<logic:notEmpty name="BookingDatesFormAgy" property="list">
  <table cellpadding="0" cellspacing="0" width="100%">
    <tr>
      <th width="15%" align="left" class="label">
        <bean:message key="label.backingReportName(s)"/>
      </th>
      <td align="left">
        <html:text name="BookingDatesFormAgy" property="backingReport" size="100" />
      </td>
    </tr>
  </table>
  <br />
