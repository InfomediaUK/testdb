...
<logic:equal name="isView" value="true">
    ...
    <html:link forward="bookingViewSummary" paramId="booking.bookingId" paramName="BookingViewFormAgy" paramProperty="booking.bookingId" titleKey="title.bookingViewSummary" >
    ...
    <td align="center" class="<bean:write name="tabClass"/>" width="20%">
    <html:link forward="bookingViewShifts" paramId="booking.bookingId" paramName="BookingViewFormAgy" paramProperty="booking.bookingId" titleKey="title.bookingViewShifts" >
    ...
    <td align="center" class="<bean:write name="tabClass"/>" width="20%">
    <html:link forward="bookingViewGrades" paramId="booking.bookingId" paramName="BookingViewFormAgy" paramProperty="booking.bookingId" titleKey="title.bookingViewGrades" >
    <bean:message key="link.tabGrades"/>
    </html:link>
    </td>
    <logic:equal name="BookingViewFormAgy" property="booking.draft" value="true">
    ...
    <logic:notEqual name="BookingViewFormAgy" property="booking.draft" value="true">
	    ...
	    <td align="center" class="<bean:write name="tabClass"/>" width="20%">
	    <html:link forward="bookingViewApplicants" paramId="booking.bookingId" paramName="BookingViewFormAgy" paramProperty="booking.bookingId" titleKey="title.bookingViewApplicants" >
	    <bean:message key="link.tabApplicants"/>
	    </html:link>
	    </td>
	    ...
	    <td align="center" class="<bean:write name="tabClass"/>" width="20%">
	    <html:link forward="bookingViewTimesheets" paramId="booking.bookingId" paramName="BookingViewFormAgy" paramProperty="booking.bookingId" titleKey="title.bookingViewTimesheets" >
	    <bean:message key="link.tabTimesheets"/>
      </html:link>
	    </td>
    </logic:notEqual>
...
--%>
<logic:notEqual name="isView" value="true">
    <bean:define id="tabClass" value="tabNotSelected"/><logic:equal name="tab" value="summary"><bean:define id="tabClass" value="tabSelected"/></logic:equal>
    <td align="center" class="<bean:write name="tabClass"/>" width="20%">
