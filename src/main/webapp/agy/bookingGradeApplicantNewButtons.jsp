...
<table cellspacing="2" border="0" cellpadding="0">
  <tr>
    <td align="left">
	    <html:submit styleId="submitButton" tabindex="<%= nextButtonTabIndex %>" styleClass="wizardButton">
	      <bean:message name="nextButtonKey"/>
	    </html:submit>
    </td>
  </tr>
  <tr>
    <td align="left">
	    <html:cancel styleId="cancelButton" tabindex="<%= backButtonTabIndex %>" styleClass="wizardButton">
