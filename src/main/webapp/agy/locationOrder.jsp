...
<form action="locationOrderProcess.do" name="SiteDisplayOrderFormAgy">
  <html:hidden name="SiteDisplayOrderFormAgy" property="order"/>
  <html:hidden name="SiteDisplayOrderFormAgy" property="zeroiseDisplayOrder"/>
  <html:hidden name="SiteDisplayOrderFormAgy" property="site.siteId"/>
  <tr>
		<td align="left" valign="middle" class="title">
<bean:message key="title.locationOrder"/>
		</td>
    <td align="right" valign="middle" width="75">
		  <html:submit onclick="javascript:loadvalues(document.SiteDisplayOrderFormAgy.commaDelimitedKey, document.SiteDisplayOrderFormAgy.order)" styleClass="titleButton">
		    <bean:message key="button.save"/>
		  </html:submit>
		</td>
    <td align="right" valign="middle" width="75">
		  <html:submit onclick="javascript:zeroiseDisplayOrder.value='true';loadvalues(document.SiteDisplayOrderFormAgy.commaDelimitedKey, document.SiteDisplayOrderFormAgy.order)" styleClass="titleButton">
...
<table class="simple" width="100%">
  ...
  <html:select name="SiteDisplayOrderFormAgy" property="commaDelimitedKey" size="20" style="width: 400px">
  <logic:iterate id="location" name="SiteDisplayOrderFormAgy" property="list" type="com.helmet.bean.Location">
  ...
  <tr>
    <td align="left">
		  <html:button onclick="javascript:swap(document.SiteDisplayOrderFormAgy.commaDelimitedKey, -1);" property="up" styleClass="titleButton">
		    <bean:message key="button.up"/>
		  </html:button>
		  <html:button onclick="javascript:swap(document.SiteDisplayOrderFormAgy.commaDelimitedKey, 1);" property="down" styleClass="titleButton">
...
function showIt() {
  alert(document.SiteDisplayOrderFormAgy.order.value);
}
