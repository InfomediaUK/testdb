...
<mmj-agy:hasAccess forward="dressCodeEdit">
    <html:form action="/dressCodeEdit.do" onsubmit="return singleSubmit();">
    <input type="hidden" name="dressCode.dressCodeId" value="<bean:write name="DressCodeFormAgy" property="dressCode.dressCodeId"/>"/>
    <td align="right" valign="middle" width="75"><html:submit styleClass="titleButton"><bean:message key="button.edit"/></html:submit></td>
    </html:form>
</mmj-agy:hasAccess>
<mmj-agy:hasAccess forward="dressCodeDelete">
    ...
    <input type="hidden" name="dressCode.locationId" value="<bean:write name="DressCodeFormAgy" property="dressCode.locationId"/>"/>
...
<table class="simple" width="100%">
  <tr>
    ...
    <td align="left" width="65%"><bean:write name="DressCodeFormAgy" property="dressCode.name"/></td>
  </tr>
</table>
