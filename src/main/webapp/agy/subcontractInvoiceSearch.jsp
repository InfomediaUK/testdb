...
<bean:message key="title.subcontractInvoiceSearch"/>
		</td>
  </tr>
</table>
<html:errors/>
<table width="100%" cellpadding="0" cellspacing="0" border="0">
<html:form action="/subcontractInvoiceSearchProcess.do" focus="subcontractInvoiceId" onreset="resetDates()" onsubmit="return singleSubmit();">
  <tr>
    <td width="80%">
<table class="simple" width="100%">
  <tr>
    ...
    <td>
      <html:text property="subcontractInvoiceId" tabindex="1"/>
    </td>
  </tr>
  <tr>
    <th>
...
<% 
for (int i = 0; i < com.helmet.bean.SubcontractInvoice.SUBCONTRACTINVOICE_STATUS_DESCRIPTION_KEYS.length; i++) {
%>
<html:option value="<%= String.valueOf(i) %>"><bean:message key="<%= com.helmet.bean.SubcontractInvoice.SUBCONTRACTINVOICE_STATUS_DESCRIPTION_KEYS[i] %>"/></html:option>
<%
}
%>
      </html:select>
...
<script type="text/javascript">
	<!--  to hide script contents from old browsers
  function clearForm() {
    document.SubcontractInvoiceSearchFormAgy.subcontractInvoiceId.value = '';
    document.SubcontractInvoiceSearchFormAgy.status.value = '';
    document.SubcontractInvoiceSearchFormAgy.clientId.value = '';
    document.SubcontractInvoiceSearchFormAgy.siteId.value = '';
    document.SubcontractInvoiceSearchFormAgy.locationId.value = '';
    document.SubcontractInvoiceSearchFormAgy.jobProfileId.value = '';
    document.SubcontractInvoiceSearchFormAgy.fromDate.value = '';
    document.SubcontractInvoiceSearchFormAgy.toDate.value = '';
    loadClients();
    resetDates();
  }
	// end hiding contents from old browsers  -->
...
function doYesterday() {
  ...
  document.SubcontractInvoiceSearchFormAgy.fromDate.value = yesterdayStr;
  document.SubcontractInvoiceSearchFormAgy.toDate.value = yesterdayStr;
}

function doToday() {
  var todayStr = getDateStr(getDate(0));
  document.SubcontractInvoiceSearchFormAgy.fromDate.value = todayStr;
  document.SubcontractInvoiceSearchFormAgy.toDate.value = todayStr;
}

function doTomorrow() {
  var tomorrowStr = getDateStr(getDate(+1));
  document.SubcontractInvoiceSearchFormAgy.fromDate.value = tomorrowStr;
  document.SubcontractInvoiceSearchFormAgy.toDate.value = tomorrowStr;
}
...
function doLastWeek() {
  document.SubcontractInvoiceSearchFormAgy.fromDate.value = getDateStr(getSOW(getDate(-7)));
  document.SubcontractInvoiceSearchFormAgy.toDate.value = getDateStr(getEOW(getDate(-7)));
}

function doThisWeek() {
  document.SubcontractInvoiceSearchFormAgy.fromDate.value = getDateStr(getSOW(getDate(0)));
  document.SubcontractInvoiceSearchFormAgy.toDate.value = getDateStr(getEOW(getDate(0)));
}
