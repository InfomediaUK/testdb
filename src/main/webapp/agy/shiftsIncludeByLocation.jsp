...
<bean:parameter id="theGroupList" name="theGroupList" value="listBookingDateUserApplicantReportGroup"/>
...
<%
Integer bookingDateRowIndex = new Integer(0);
...
<logic:iterate id="bookingDateUserApplicantReportGroup" name="<%= theFormAgy %>" property="<%= theGroupList %>" type="com.helmet.application.BookingDateUserApplicantReportGroup" indexId="bookingDateUserApplicantReportGroupIndex">
	<thead>
  <tr>
    <th align="left" colspan="<%= totalColumns %>">
      <bean:write name="bookingDateUserApplicantReportGroup" property="reportGroupName"/>
      (<bean:write name="bookingDateUserApplicantReportGroup" property="size"/>)
    </th>
  </tr>
  </thead>
  <logic:iterate id="bookingDate" name="bookingDateUserApplicantReportGroup" property="listBookingDateUserApplicant" type="com.helmet.bean.BookingDateUserApplicant" indexId="bookingDateIndex" >
  ...
  <logic:equal name="showCheckbox" value="true">
    ...
    <logic:equal name="renderCheckbox" value="true">
			<html:multibox name="<%= theFormAgy %>" property="selectedBookingDates" styleId="<%= \"bd\" + bookingDateRowIndex++ %>">
...
<logic:greaterThan name="bookingDate" property="applicantId" value="0">
  <tr class="highlightoff" onmouseover="this.className='highlighton';" onmouseout="this.className='highlightoff';">
	  <td colspan="3">
		...
		<logic:greaterThan name="bookingDate" property="applicantOriginalAgencyId" value="0">&nbsp;*&nbsp;</logic:greaterThan>
	  (<bean:write name="bookingDate" property="agencyName"/>)&nbsp;<bean:message key="label.currencySymbol"/><bean:write name="bookingDate" property="chargeRate" format="#0.00"/>
	  </td>   
    <td align="left">
    <logic:equal name="bookingDate" property="undefinedShift" value="true">
      Undefined
...
<logic:equal name="showTotals" value="true">
  <% bookingDateUserApplicantReportGroup.sortShiftTotals(); %>
  <tr class="highlightoff" onmouseover="this.className='highlighton';" onmouseout="this.className='highlightoff';">
    <th align="left" colspan="5">
      <bean:message key="label.total"/>&nbsp;<bean:write name="bookingDateUserApplicantReportGroup" property="reportGroupName"/>
    </th>
  <logic:equal name="showHrs" value="true">
    <td align="right"><bean:write name="bookingDateUserApplicantReportGroup" property="totalHours" format="#0.00"/></td>
  </logic:equal>
  <logic:equal name="showAgreed" value="true">
    <td align="right">
      <bean:message key="label.currencySymbol"/><bean:write name="bookingDateUserApplicantReportGroup" property="totalAgreedValue" format="#,##0.00"/>
  <logic:equal name="consultant" property="canViewWages" value="true"><%-- Consultant CAN view wages. Show wage... --%>
      &nbsp;<bean:message key="label.currencySymbol"/><bean:write name="bookingDateUserApplicantReportGroup" property="totalAgreedWageRateValue" format="#,##0.00"/>
  </logic:equal>
    </td>
  </logic:equal>
  <logic:equal name="showActuals" value="true">
    <td align="right"><bean:write name="bookingDateUserApplicantReportGroup" property="totalActualHours" format="#0.00"/></td>
    <td align="right">
      <bean:message key="label.currencySymbol"/><bean:write name="bookingDateUserApplicantReportGroup" property="totalActualValue" format="#,##0.00"/>
  <logic:equal name="consultant" property="canViewWages" value="true"><%-- Consultant CAN view wages. Show wage... --%>
      &nbsp;<bean:message key="label.currencySymbol"/><bean:write name="bookingDateUserApplicantReportGroup" property="totalActualWageRateValue" format="#,##0.00"/>
  </logic:equal>
    </td>
    <td align="right">
      <bean:message key="label.currencySymbol"/><bean:write name="bookingDateUserApplicantReportGroup" property="totalExpenseValue" format="#,##0.00"/>
    </td>
  </logic:equal>
  <logic:equal name="showVat" value="true">
    <td align="right">
      <bean:message key="label.currencySymbol" /><bean:write name="bookingDateUserApplicantReportGroup" property="totalTotalVatValue" format="#,##0.00"/>
    </td>
    <td align="right">
      <bean:message key="label.currencySymbol" /><bean:write name="bookingDateUserApplicantReportGroup" property="totalActualTotalValue" format="#,##0.00"/>
    </td>
  </logic:equal>
    <th align="right">&nbsp;</th>
  </tr>
