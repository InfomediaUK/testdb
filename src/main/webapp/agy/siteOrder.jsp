...
<form action="siteOrderProcess.do" name="ClientDisplayOrderFormAgy">
...
<bean:message key="title.siteOrder"/>
		</td>
...
<table class="simple" width="100%">
  ...
  <logic:iterate id="site" name="ClientDisplayOrderFormAgy" property="list" type="com.helmet.bean.Site">
    <bean:define id="id" name="site" property="siteId" />
    <bean:define id="noOfChanges" name="site" property="noOfChanges" />
    <bean:define id="name" name="site" property="name" />
