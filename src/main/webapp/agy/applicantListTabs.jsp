...
<table class="tabs" width="100%">
  <tr>
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterA">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterB">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterC">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterD">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterE">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterF">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterG">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterH">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterI">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterJ">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterK">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterL">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterM">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterN">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterO">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterP">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterQ">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterR">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterS">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterT">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterU">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterV">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterW">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterX">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterY">
    ...
    <td align="center" class="<bean:write name="tabClass"/>">
      <html:link forward="applicantList" paramId="indexLetter"  paramName="indexLetterZ">
