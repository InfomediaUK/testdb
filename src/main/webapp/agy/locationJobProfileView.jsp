...
<mmj-agy:hasAccess forward="locationJobProfileEdit">
    ...
    <input type="hidden" name="locationJobProfile.locationJobProfileId" value="<bean:write name="LocationJobProfileFormAgy" property="locationJobProfile.locationJobProfileId"/>"/>
    ...
    <input type="hidden" name="locationJobProfile.locationId" value="<bean:write name="LocationJobProfileFormAgy" property="locationJobProfile.locationId"/>"/>
...
<table class="simple" width="100%">
  ...
  <tr>
    ...
    <td align="left"><bean:write name="LocationJobProfileFormAgy" property="locationJobProfile.rate" format="#,##0.00" /></td>
  </tr>
</table>
