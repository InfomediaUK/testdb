...
<form action="reasonForRequestOrderProcess.do" name="ClientDisplayOrderFormAgy">
  <html:hidden name="ClientDisplayOrderFormAgy" property="order"/>
  <html:hidden name="ClientDisplayOrderFormAgy" property="zeroiseDisplayOrder"/>
  <html:hidden name="ClientDisplayOrderFormAgy" property="client.clientId"/>  
  <tr>
		<td align="left" valign="middle" class="title">
<bean:message key="title.reasonForRequestOrder"/>
		</td>
    <td align="right" valign="middle" width="75">
		  <html:submit onclick="javascript:loadvalues(document.ClientDisplayOrderFormAgy.commaDelimitedKey, document.ClientDisplayOrderFormAgy.order)" styleClass="titleButton">
		    <bean:message key="button.save"/>
		  </html:submit>
		</td>
    <td align="right" valign="middle" width="75">
		  <html:submit onclick="javascript:zeroiseDisplayOrder.value='true';loadvalues(document.ClientDisplayOrderFormAgy.commaDelimitedKey, document.ClientDisplayOrderFormAgy.order)" styleClass="titleButton">
...
<table class="simple" width="100%">
  ...
  <html:select name="ClientDisplayOrderFormAgy" property="commaDelimitedKey" size="20" style="width: 400px">
  <logic:iterate id="reasonForRequest" name="ClientDisplayOrderFormAgy" property="list" type="com.helmet.bean.ReasonForRequest">
    <bean:define id="id" name="reasonForRequest" property="reasonForRequestId" />
    <bean:define id="noOfChanges" name="reasonForRequest" property="noOfChanges" />
    <bean:define id="name" name="reasonForRequest" property="name" />
  ...
  <tr>
    <td align="left">
		  <html:button onclick="javascript:swap(document.ClientDisplayOrderFormAgy.commaDelimitedKey, -1);" property="up" styleClass="titleButton">
		    <bean:message key="button.up"/>
		  </html:button>
		  <html:button onclick="javascript:swap(document.ClientDisplayOrderFormAgy.commaDelimitedKey, 1);" property="down" styleClass="titleButton">
...
function showIt() {
  alert(document.ClientDisplayOrderFormAgy.order.value);
}
