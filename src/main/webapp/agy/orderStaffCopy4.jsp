...
<table>
  <tr>
    <td align="left" valign="middle" width="250">
      <bean:message key="title.orderStaffCopyStep4"/>
      -&nbsp;<bean:message key="title.orderStaffCopy4"/>
    </td>
    <td align="left" valign="top">
<html:form action="/orderStaffCopy5.do" onsubmit="javascript:cal.submitFlatDates(); return singleSubmit();">
...
<hr/>
<html:errors />
<form name="helperFormAgy" action="javascript:doDates(true)" method="POST" onReset="resetDates()"> 
...
<script type="text/javascript" language="JavaScript">
  <!--
  var focusControl = document.forms["helperFormAgy"].elements["fromDate"];
...
<bean:define id="dates" name="OrderStaffCopyFormAgy" property="dates" type="java.lang.String" />

<script type="text/javascript">//<![CDATA[
<!--  to hide script contents from old browsers

function doMondayToFriday() {
  document.helperFormAgy.monday.checked = true;
  document.helperFormAgy.tuesday.checked = true;
  document.helperFormAgy.wednesday.checked = true;
  document.helperFormAgy.thursday.checked = true;
  document.helperFormAgy.friday.checked = true;
  document.helperFormAgy.saturday.checked = false;
  document.helperFormAgy.sunday.checked = false;
}
...
var SPECIAL_DAYS = [
<logic:iterate id="publicHoliday" name="OrderStaffCopyFormAgy" property="list" indexId="publicHolidayIndex">
  ...
  if (useFromAndTo) {
	...
	//  toYear);
	  ...
	  while (theFromDate <= theToDate) {
	    ...
	    switch (dow){
	      case 0: 
					if (document.helperFormAgy.sunday.checked) doit = true; break; 
	      case 1: 
					if (document.helperFormAgy.monday.checked) doit = true; break;
	      case 2: 
					if (document.helperFormAgy.tuesday.checked) doit = true; break;
	      case 3: 
					if (document.helperFormAgy.wednesday.checked) doit = true; break;
	      case 4: 
					if (document.helperFormAgy.thursday.checked) doit = true; break;
	      case 5: 
					if (document.helperFormAgy.friday.checked) doit = true; break;
	      case 6: 
					if (document.helperFormAgy.saturday.checked) doit = true; break;
	    }
		  if (doit) {
