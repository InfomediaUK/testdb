...
<table class="tabs" width="100%">
  <tr>
    ...
    <a href="javascript:doSearchAndSubmit('ShiftSearchFormAgy', 'shiftSearchProcess.do')">
...
<%--
    ...
    <td align="center" class="<bean:write name="tabClass"/>" width="20%">
    <a href="javascript:doSearchAndSubmit('ShiftSearchFormAgy., 'shiftSearchProcess2.do')">
...
--%>
    ...
    <td align="center" class="<bean:write name="tabClass"/>" width="20%">
    <a href="javascript:doSearchAndSubmit('ShiftSearchFormAgy', 'shiftSearchProcess3.do')">
