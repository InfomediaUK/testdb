...
<form action="shiftOrderProcess.do" name="LocationDisplayOrderFormAgy">
...
<table class="simple" width="100%">
  ...
  <logic:iterate id="shift" name="LocationDisplayOrderFormAgy" property="list" type="com.helmet.bean.Shift">
