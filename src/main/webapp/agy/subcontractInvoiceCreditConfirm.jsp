...
%>
	<table cellpadding="0" cellspacing="0" width="100%" height="30">
	  <tr>
			<td align="left" valign="middle" class="title"><bean:message key="title.subcontractCreditNote"/></td>
<mmj-agy:hasAccess forward="subcontractInvoiceCredit">
	    <td align="right" valign="middle" width="80">
  <html:form action="/subcontractInvoiceCreditProcess.do" onsubmit="return singleSubmit();">
        <html:hidden name="SubcontractInvoiceCreditFormAgy" property="subcontractInvoiceUser.subcontractInvoiceId" />
        <html:hidden name="SubcontractInvoiceCreditFormAgy" property="subcontractInvoiceUser.date" />
        <html:hidden name="SubcontractInvoiceCreditFormAgy" property="subcontractInvoiceUser.notes" />
	...
	<table class="simple" width="100%">
	  ...
	  <tr>
	    <th align="left"><bean:message key="label.creditDate"/></th>
	    <td align="left">
	  ...
	  <tr>
	    <th align="left">Related Invoice</th>
	    <td align="left">
