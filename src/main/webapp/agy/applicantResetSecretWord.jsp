...
<bean:message key="title.applicantResetSecretWord"/>
		</td>
<logic:equal name="ApplicantFormAgy" property="applicant.active" value="true">
<mmj-agy:hasAccess forward="applicantResetSecretWord">
		<html:form action="applicantResetSecretWordProcess.do" onsubmit="return singleSubmit();">
...
<table class="simple" width="100%">
  ...
  <tr>
    ...
    <td align="left"><bean:write name="ApplicantFormAgy" property="applicant.professionalReference"/></td>
  </tr>
  <tr>
