...
<html:form action="/sendClientConfirmationEmailProcess.do" focus="toEmailAddress" onsubmit="return singleSubmit();">
<html:hidden property="referer"/>
  <tr>
		<td align="left" valign="middle" class="title">
<bean:message key="title.sendClientConfirmationEmail"/>
		</td>
...
<table class="simple" width="100%">
  <tr>
    ...
    <td width="75%">
      <bean:write name="SendClientConfirmationEmailFormAgy" property="fromEmailAddress"/>
  ...
  <logic:notEmpty name="SendClientConfirmationEmailFormAgy" property="attachment">
  <tr>
    <th align="left">
      <bean:message key="label.attachment"/>
    </th>
    <td align="left">
      <bean:write name="SendClientConfirmationEmailFormAgy" property="attachmentFileName"/>
