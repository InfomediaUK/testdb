...
<bean:define id="dates" name="OrderStaffFormAgy" property="dates" type="java.lang.String" />
...
var SPECIAL_DAYS = [
<logic:iterate id="publicHoliday" name="OrderStaffFormAgy" property="list" indexId="publicHolidayIndex">
