...
<bean:define id="dates" name="BookingExtendFormAgy" property="dates" type="java.lang.String" />
...
var DISABLED_DAYS = [
<logic:iterate id="bookingDate" name="BookingExtendFormAgy" property="currentBookingDates" indexId="bookingDateIndex">
...
var SPECIAL_DAYS = [
<logic:iterate id="publicHoliday" name="BookingExtendFormAgy" property="list" indexId="publicHolidayIndex">
