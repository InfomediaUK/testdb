...
<form action="dressCodeOrderProcess.do" name="LocationDisplayOrderFormAgy">
...
<table class="simple" width="100%">
  ...
  <logic:iterate id="dressCode" name="LocationDisplayOrderFormAgy" property="list" type="com.helmet.bean.DressCode">
