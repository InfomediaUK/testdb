...
%>
<html:form action="/subcontractInvoiceDeleteProcess.do" onsubmit="return singleSubmit();">
	<table cellpadding="0" cellspacing="0" width="100%" height="30">
	  <tr>
			<td align="left" valign="middle" class="title">
			  <bean:message key="title.subcontractInvoiceDelete"/>
			</td>
...
<logic:iterate id="subcontractInvoiceItem" name="SubcontractInvoiceFormAgy" property="list" indexId="subcontractInvoiceItemIndex" type="com.helmet.bean.SubcontractInvoiceItem">
  ...
  <logic:notEmpty  name="subcontractInvoiceItem" property="comment" >
	    ...
	    <td align="left" colspan="7">
	      Notes:-<br />
	      <html:textarea name="SubcontractInvoiceFormAgy" property="subcontractInvoiceUser.notes" style="width:100%" styleId="message" cols="100" rows="12" disabled="false" />      
	    </td>
	  </tr>
</table>	
</html:form>
