...
<bean:message key="title.shiftSearch"/>&nbsp;MI Data
		</td>
  </tr>
</table>
<html:errors/>
<table width="100%" cellpadding="0" cellspacing="0" border="0">
<html:form action="/shiftSearchMiDataProcess.do" focus="bookingId" onreset="resetDates()" onsubmit="return singleSubmit();">
  <tr>
    <td width="80%">
