...
<mmj-agy:hasAccess forward="expenseEdit">
    ...
    <input type="hidden" name="expense.expenseId" value="<bean:write name="ExpenseFormAgy" property="expense.expenseId"/>"/>
    <td align="right" valign="middle" width="75"><html:submit styleClass="titleButton"><bean:message key="button.edit"/></html:submit></td>
    </html:form>
</mmj-agy:hasAccess>
<mmj-agy:hasAccess forward="expenseDelete">
    ...
    <input type="hidden" name="expense.locationId" value="<bean:write name="ExpenseFormAgy" property="expense.locationId"/>"/>
...
<table class="simple" width="100%">
  <tr>
    ...
    <td align="left" width="65%"><bean:write name="ExpenseFormAgy" property="expense.name"/></td>
  </tr>
  <tr>
    <th align="left"><bean:message key="label.description"/></th>
    <td align="left"><bean:write name="ExpenseFormAgy" property="expense.description"/></td>
  </tr>
  <tr>
    <th align="left"><bean:message key="label.code"/></th>
    <td align="left"><bean:write name="ExpenseFormAgy" property="expense.code"/></td>
  </tr>
  <tr>
    <th align="left"><bean:message key="label.multiplier"/></th>
    <td align="left"><bean:write name="ExpenseFormAgy" property="multiplierStr"/></td>
  </tr>
  <tr>
    <th align="left"><bean:message key="label.vatRate"/></th>
    <td align="left"><bean:write name="ExpenseFormAgy" property="vatRateStr"/></td>
  </tr>
</table>
