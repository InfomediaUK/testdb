...
<mmj-agy:hasAccess forward="locationEdit">
    ...
    <input type="hidden" name="location.locationId" value="<bean:write name="LocationViewFormAgy" property="location.locationId"/>"/>
...
<mmj-agy:hasAccess forward="locationDelete">
    ...
    <input type="hidden" name="location.siteId" value="<bean:write name="LocationViewFormAgy" property="location.siteId"/>"/>
...
<table class="simple" width="100%">
  <tr>
    ...
    <td align="left" colspan="3">
  	  <html:link forward="siteView" paramId="site.siteId" paramName="LocationViewFormAgy" paramProperty="location.siteId"><bean:write name="LocationViewFormAgy" property="location.siteName"/></html:link>
    </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<logic:equal name="LocationViewFormAgy" property="location.nhsMatched" value="true">
    <td align="left" colspan="3" class="nhsMatched">
  </logic:equal>
	<logic:notEqual name="LocationViewFormAgy" property="location.nhsMatched" value="true">
    <td align="left" colspan="3">
  </logic:notEqual>
      <bean:write name="LocationViewFormAgy" property="location.nhsWard"/>
    </td>
  </tr>
  <tr>
...
<mmj-agy:hasAccess forward="shiftNew">
    ...
    <input type="hidden" name="shift.locationId" value="<bean:write name="LocationViewFormAgy" property="location.locationId"/>"/>
    <td align="right" valign="middle" width="75"><html:submit styleClass="titleButton"><bean:message key="button.new"/></html:submit></td>
    </html:form>
</mmj-agy:hasAccess>
<mmj-agy:hasAccess forward="shiftOrder">
...
<table class="simple" width="100%">
  ...
  <tr>
	...
	<logic:iterate id="shift" name="LocationViewFormAgy" property="location.shifts">
  ...
  <tr class="<bean:write name="trClass"/>">
	  <td align="left">
    <mmj-agy:hasAccess forward="shiftView">
    ...
    <mmj-agy:hasNoAccess forward="shiftView">
...
<mmj-agy:hasAccess forward="dressCodeNew">
    ...
    <input type="hidden" name="dressCode.locationId" value="<bean:write name="LocationViewFormAgy" property="location.locationId"/>"/>
    <td align="right" valign="middle" width="75"><html:submit styleClass="titleButton"><bean:message key="button.new"/></html:submit></td>
    </html:form>
</mmj-agy:hasAccess>
<mmj-agy:hasAccess forward="dressCodeOrder">
...
<table class="simple" width="100%">
  ...
  <tr>
	...
	<logic:iterate id="dressCode" name="LocationViewFormAgy" property="location.dressCodes">
  ...
  <tr class="<bean:write name="trClass"/>">
	  <td align="left">
    <mmj-agy:hasAccess forward="dressCodeView">
    ...
    <mmj-agy:hasNoAccess forward="dressCodeView">
...
<mmj-agy:hasAccess forward="expenseNew">
    <html:form action="/expenseNew.do" onsubmit="return singleSubmit();">
    <input type="hidden" name="expense.locationId" value="<bean:write name="LocationViewFormAgy" property="location.locationId"/>"/>
    <td align="right" valign="middle" width="75"><html:submit styleClass="titleButton"><bean:message key="button.new"/></html:submit></td>
    </html:form>
</mmj-agy:hasAccess>
<mmj-agy:hasAccess forward="expenseOrder">
...
<table class="simple" width="100%">
  ...
  <tr>
	...
	<logic:iterate id="expense" name="LocationViewFormAgy" property="location.expenses">
  ...
  <tr class="<bean:write name="trClass"/>">
    <td align="left">
    <mmj-agy:hasAccess forward="expenseView">
    ...
    <mmj-agy:hasNoAccess forward="expenseView">
...
<table class="simple" width="100%">
  ...
  <logic:iterate id="locationJobProfileUser" name="LocationViewFormAgy" property="location.locationJobProfileUsers" indexId="indexId">
  <tr>
    <td align="left">
    ...
    <td align="left">
      <bean:write name="locationJobProfileUser" property="nhsAssignment"/>
    </td>
    <td align="right">
      <bean:write name="locationJobProfileUser" property="budget" format="#0.00"/>
    </td>
    <td align="right">
    <mmj-agy:hasAccess forward="locationJobProfileView">
	...
	<mmj-agy:hasNoAccess forward="locationJobProfileView">
