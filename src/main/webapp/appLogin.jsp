...
<br/>
<h2><bean:message key="title.appLogin" /></h2>
<html:errors />
<table>
<html:form action="appLoginProcess.do" focus="login">
  <tr>
  ...
  <tr>
    ...
    <td align="left"><html:password property="pwd" maxlength="9"/></td>
  </tr>
  <tr>
...
<%--
<br/>
<html:link forward="appForgottenPwd"><bean:message key="link.forgottenPwd"/></html:link>
--%>
