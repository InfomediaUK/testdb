...
%><br/>
<h2><bean:message key="title.adminForgottenPwd" /></h2>
<html:errors />
<table>
<html:form action="adminForgottenPwdProcess.do" focus="administrator.user.login">
  <tr>
  ...
  <tr>
    ...
    <td align="left"><html:password property="administrator.user.secretWord" maxlength="20"/></td>
  </tr>
  <tr>
