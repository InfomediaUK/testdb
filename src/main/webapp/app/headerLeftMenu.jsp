...
<logic:equal name="applicant" property="canToggleHideMoney" value="true">
      <html:link forward="toggleHideMoney" titleKey="link.title.toggleMoney"><bean:message key="link.toggleMoney"/></html:link>
      &bull;
</logic:equal>
...
function doPopupHelp() {
  ...
  var test = window.open("<%= request.getContextPath() %>/app/help.do","help",options);
  if (test == null) {
