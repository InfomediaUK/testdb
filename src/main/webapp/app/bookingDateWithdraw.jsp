...
<html:form action="bookingDateWithdrawProcess.do" onsubmit="return singleSubmit();">
<html:hidden property="bookingDate.bookingDateId" />
<html:hidden property="bookingDate.noOfChanges" />
  <tr>
		<td align="left" valign="middle" class="title">
<bean:message key="title.bookingDateWithdraw"/>
		</td>
...
<table class="simple" width="100%">
  ...
  <tr>
    ...
    <td align="left">
<logic:equal name="BookingDateViewFormApp" property="bookingDate.undefinedShift" value="true">
      Undefined
</logic:equal>
<logic:notEqual name="BookingDateViewFormApp" property="bookingDate.undefinedShift" value="true">
