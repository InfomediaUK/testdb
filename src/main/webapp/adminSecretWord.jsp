...
%><br/>
<h2><bean:message key="title.adminSecretWord" /></h2>
<html:errors />
<table>
<html:form action="adminSecretWordProcess.do" focus="secretWordValue1">
  <html:hidden property="secretWordKey1"/>
  <html:hidden property="secretWordKey2"/>
  <html:hidden property="secretWordKey3"/>
  <tr>
    <td align="left" class="label"><bean:write name="AdminSecretWordForm" property="secretWordKey1"/></td>
    ...
    <td align="left" class="label"><bean:write name="AdminSecretWordForm" property="secretWordKey2"/></td>
    ...
    <td align="left" class="label"><bean:write name="AdminSecretWordForm" property="secretWordKey3"/></td>
