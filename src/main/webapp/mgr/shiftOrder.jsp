...
<form action="shiftOrderProcess.do" name="LocationDisplayOrderFormMgr">
...
<bean:message key="title.shiftOrder"/>
		</td>
...
<table class="simple" width="100%">
  ...
  <logic:iterate id="shift" name="LocationDisplayOrderFormMgr" property="list" type="com.helmet.bean.Shift">
    <bean:define id="id" name="shift" property="shiftId" />
    <bean:define id="noOfChanges" name="shift" property="noOfChanges" />
    <bean:define id="name" name="shift" property="name" />
