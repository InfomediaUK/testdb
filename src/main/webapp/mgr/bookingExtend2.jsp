...
<logic:greaterThan name="BookingExtendFormMgr" property="noOfDates" value="1">
...
<hr/>
<html:errors />
<logic:equal name="BookingExtendFormMgr" property="noOfDates" value="1">
<table class="radio">
<logic:iterate id="shift" name="BookingExtendFormMgr" property="shifts" indexId="shiftIndex">
  <tr>
    <td>
...
<logic:greaterThan name="BookingExtendFormMgr" property="noOfDates" value="1">
<table>
<logic:iterate id="bookingDate" name="BookingExtendFormMgr" property="bookingDates" indexId="bookingDateIndex">
  <tr>
    <td align="left">
...
<html:select tabindex="1" property='<%= "bookingDates[" + bookingDateIndex + "].shiftId" %>'>
	<logic:iterate id="shift" name="BookingExtendFormMgr" property="shifts" indexId="shiftIndex" type="com.helmet.bean.Shift">
