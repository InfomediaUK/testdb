...
<form action="dressCodeOrderProcess.do" name="LocationDisplayOrderFormMgr">
  <html:hidden name="LocationDisplayOrderFormMgr" property="order"/>
  <html:hidden name="LocationDisplayOrderFormMgr" property="zeroiseDisplayOrder"/>
  <html:hidden name="LocationDisplayOrderFormMgr" property="location.locationId"/>
  <tr>
		<td align="left" valign="middle" class="title">
<bean:message key="title.dressCodeOrder"/>
		</td>
    <td align="right" valign="middle" width="75">
		  <html:submit onclick="javascript:loadvalues(document.LocationDisplayOrderFormMgr.commaDelimitedKey, document.LocationDisplayOrderFormMgr.order)" styleClass="titleButton">
		    <bean:message key="button.save"/>
		  </html:submit>
		</td>
    <td align="right" valign="middle" width="75">
		  <html:submit onclick="javascript:zeroiseDisplayOrder.value='true';loadvalues(document.LocationDisplayOrderFormMgr.commaDelimitedKey, document.LocationDisplayOrderFormMgr.order)" styleClass="titleButton">
...
<table class="simple" width="100%">
  ...
  <html:select name="LocationDisplayOrderFormMgr" property="commaDelimitedKey" size="20" style="width: 400px">
  <logic:iterate id="dressCode" name="LocationDisplayOrderFormMgr" property="list" type="com.helmet.bean.DressCode">
    <bean:define id="id" name="dressCode" property="dressCodeId" />
    <bean:define id="noOfChanges" name="dressCode" property="noOfChanges" />
    <bean:define id="name" name="dressCode" property="name" />
  ...
  <tr>
    <td align="left">
		  <html:button onclick="javascript:swap(document.LocationDisplayOrderFormMgr.commaDelimitedKey, -1);" property="up" styleClass="titleButton">
		    <bean:message key="button.up"/>
		  </html:button>
		  <html:button onclick="javascript:swap(document.LocationDisplayOrderFormMgr.commaDelimitedKey, 1);" property="down" styleClass="titleButton">
...
function showIt() {
  alert(document.LocationDisplayOrderFormMgr.order.value);
}
