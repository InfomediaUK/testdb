...
<mmj-mgr:hasAccess forward="shiftEdit">
    <html:form action="/shiftEdit.do" onsubmit="return singleSubmit();">
    <input type="hidden" name="shift.shiftId" value="<bean:write name="ShiftFormMgr" property="shift.shiftId"/>"/>
...
<mmj-mgr:hasAccess forward="shiftDelete">
    ...
    <input type="hidden" name="shift.locationId" value="<bean:write name="ShiftFormMgr" property="shift.locationId"/>"/>
