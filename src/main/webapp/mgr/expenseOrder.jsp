...
<form action="expenseOrderProcess.do" name="LocationDisplayOrderFormMgr">
...
<table class="simple" width="100%">
  ...
  <logic:iterate id="expense" name="LocationDisplayOrderFormMgr" property="list" type="com.helmet.bean.Expense">
