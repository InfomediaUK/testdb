...
<html:form action="/siteNewProcess.do" focus="site.name" onsubmit="return singleSubmit();">
<html:hidden property="site.noOfChanges"/>
  <tr>
		<td align="left" valign="middle" class="title">
<bean:message key="title.siteNew"/>
		</td>
...
<table class="simple" width="100%">
  <tr>
    ...
    <td align="left" width="65%"><html:text property="site.name"/></td>
  </tr>
  <tr>
