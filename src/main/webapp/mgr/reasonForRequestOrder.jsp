...
<form action="reasonForRequestOrderProcess.do" name="DisplayOrderFormMgr">
...
<table class="simple" width="100%">
  ...
  <logic:iterate id="reasonForRequest" name="DisplayOrderFormMgr" property="list" type="com.helmet.bean.ReasonForRequest">
