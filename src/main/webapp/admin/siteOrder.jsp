...
<form action="siteOrderProcess.do" name="ClientDisplayOrderFormAdmin">
  <html:select name="ClientDisplayOrderFormAdmin" property="commaDelimitedKey" size="20" style="width: 400px">
  <logic:iterate id="site" name="ClientDisplayOrderFormAdmin" property="list" type="com.helmet.bean.Site">
