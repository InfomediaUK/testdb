...
<bean:message key="title.agencyOrder"/>

<br/>
<br/>

<logic:present name="DisplayOrderFormAdmin" property="list">
<form action="agencyOrderProcess.do" name="DisplayOrderFormAdmin">
  <html:select name="DisplayOrderFormAdmin" property="commaDelimitedKey" size="20" style="width: 400px">
  <logic:iterate id="agency" name="DisplayOrderFormAdmin" property="list" type="com.helmet.bean.Agency">
    <bean:define id="id" name="agency" property="agencyId" />
    <bean:define id="noOfChanges" name="agency" property="noOfChanges" />
    <bean:define id="name" name="agency" property="name" />
