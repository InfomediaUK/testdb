...
<bean:message key="title.emailActionEdit"/>

<br/>
<b><bean:message key="warning.emailNotification.edit"/></b>
<br/>
<html:errors/>

<html:form action="emailActionEditProcess.do" focus="emailAction.name">

<html:hidden name="EmailActionFormAdmin" property="emailAction.emailActionId"/>
<html:hidden name="EmailActionFormAdmin" property="emailAction.noOfChanges"/>
