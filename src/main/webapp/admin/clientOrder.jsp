...
<bean:message key="title.clientOrder"/>

<br/>
<br/>

<logic:present name="DisplayOrderFormAdmin" property="list">
<form action="clientOrderProcess.do" name="DisplayOrderFormAdmin">
  <html:select name="DisplayOrderFormAdmin" property="commaDelimitedKey" size="20" style="width: 400px">
  <logic:iterate id="client" name="DisplayOrderFormAdmin" property="list" type="com.helmet.bean.Client">
    <bean:define id="id" name="client" property="clientId" />
    <bean:define id="noOfChanges" name="client" property="noOfChanges" />
    <bean:define id="name" name="client" property="name" />
