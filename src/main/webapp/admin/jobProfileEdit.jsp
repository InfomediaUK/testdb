...
<bean:message key="title.jobProfileEdit"/>
...
<html:form action="jobProfileEditProcess.do" onsubmit="javascript:sortCheckBoxes();" focus="jobProfile.name">
...
--%>
  ...
  <tr>
    ...
    <td align="left"><html:text property="jobProfile.documentURL" size="50"/></td>
  </tr>
