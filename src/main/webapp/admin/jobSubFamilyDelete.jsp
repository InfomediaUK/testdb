...
<bean:message key="title.jobSubFamilyDelete"/>
...
<html:form action="jobSubFamilyDeleteProcess.do">
...
<table>
  <tr>
    ...
    <td align="left"><bean:write name="JobSubFamilyViewFormAdmin" property="client.name"/> (<bean:write name="JobSubFamilyViewFormAdmin" property="client.countryName"/>)</td>
  </tr>
  <tr>
    <td align="left"><bean:message key="label.jobFamily"/></td>
    <td align="left"><bean:write name="JobSubFamilyViewFormAdmin" property="jobFamily.name"/> (<bean:write name="JobSubFamilyViewFormAdmin" property="jobFamily.code"/>)</td>
  </tr>
  <tr>
