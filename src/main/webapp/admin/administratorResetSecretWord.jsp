...
<bean:message key="title.administratorResetSecretWord"/>
...
<html:form action="administratorResetSecretWordProcess.do">

<html:hidden property="administrator.administratorId" />
<html:hidden property="administrator.user.login" />
