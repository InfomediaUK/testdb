...
<form action="dressCodeOrderProcess.do" name="LocationDisplayOrderFormAdmin">
  <html:select name="LocationDisplayOrderFormAdmin" property="commaDelimitedKey" size="20" style="width: 400px">
  <logic:iterate id="dressCode" name="LocationDisplayOrderFormAdmin" property="list" type="com.helmet.bean.DressCode">
