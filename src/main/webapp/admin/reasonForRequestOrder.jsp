...
<form action="reasonForRequestOrderProcess.do" name="ClientDisplayOrderFormAdmin">
  <html:select name="ClientDisplayOrderFormAdmin" property="commaDelimitedKey" size="20" style="width: 400px">
  <logic:iterate id="reasonForRequest" name="ClientDisplayOrderFormAdmin" property="list" type="com.helmet.bean.ReasonForRequest">
