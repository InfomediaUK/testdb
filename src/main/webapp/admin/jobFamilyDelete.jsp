...
<bean:message key="title.jobFamilyDelete"/>
...
<html:form action="jobFamilyDeleteProcess.do">
...
<table>
  ...
  <tr>
    ...
    <td align="left"><bean:write name="JobFamilyFormAdmin" property="jobFamily.name"/></td>
  </tr>
  <tr>
    <td align="left"><bean:message key="label.code"/></td>
    <td align="left"><bean:write name="JobFamilyFormAdmin" property="jobFamily.code"/></td>
  </tr>
  <tr>
