...
<bean:message key="title.passportTypeEdit"/>
<br/>
<br/>
<html:errors/>
<html:form action="passportTypeEditProcess.do" focus="passportType.name">
	<html:hidden name="PassportTypeFormAdmin" property="passportType.passportTypeId"/>
	<html:hidden name="PassportTypeFormAdmin" property="passportType.noOfChanges"/>
	<table>
	  <tr>
