...
<form action="shiftOrderProcess.do" name="LocationDisplayOrderFormAdmin">
  <html:select name="LocationDisplayOrderFormAdmin" property="commaDelimitedKey" size="20" style="width: 400px">
  <logic:iterate id="shift" name="LocationDisplayOrderFormAdmin" property="list" type="com.helmet.bean.Shift">
