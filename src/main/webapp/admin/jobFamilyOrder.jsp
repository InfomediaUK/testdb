...
<bean:message key="title.jobFamilyOrder"/>
...
<form action="jobFamilyOrderProcess.do" name="ClientDisplayOrderFormAdmin">
  <html:select name="ClientDisplayOrderFormAdmin" property="commaDelimitedKey" size="20" style="width: 400px">
  <logic:iterate id="jobFamily" name="ClientDisplayOrderFormAdmin" property="list" type="com.helmet.bean.JobFamily">
    <bean:define id="id" name="jobFamily" property="jobFamilyId" />
    <bean:define id="noOfChanges" name="jobFamily" property="noOfChanges" />
    <bean:define id="name" name="jobFamily" property="name" />
