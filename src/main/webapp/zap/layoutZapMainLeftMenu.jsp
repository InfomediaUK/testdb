...
<title>ZAP - <bean:message name="titleKey" property="value" scope="page"/> - <bean:write name="agency" property="name"/></title>
...
<meta http-equiv="Refresh" content="<%= pageContext.getSession().getMaxInactiveInterval() %>; url=<%= request.getContextPath() %>/zapLoggedOut.do">
...
//  alert(theRequest);
  theRequest.open("POST", "<%= request.getContextPath() %>/zap/toggleShowPageHelp.do", true);
