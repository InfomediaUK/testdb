...
%><br/>
<h2><bean:message key="title.appSecretWord" /></h2>
<html:errors />
<table>
<html:form action="appSecretWordProcess.do" focus="secretWordValue1">
  <html:hidden property="secretWordKey1"/>
  <html:hidden property="secretWordKey2"/>
  <html:hidden property="secretWordKey3"/>
  <tr>
    <td align="left" class="label"><bean:write name="AppSecretWordForm" property="secretWordKey1"/></td>
    ...
    <td align="left" class="label"><bean:write name="AppSecretWordForm" property="secretWordKey2"/></td>
    ...
    <td align="left" class="label"><bean:write name="AppSecretWordForm" property="secretWordKey3"/></td>
